 ...
 * Alumno. ID el tipo de dato de su ID (La clave primaria de T). R es el tipo de
 * dato del repositorio, en este caso AlumnoRepository.
 * 
 * Este tipo de datos se llama "delimitado". ¿Qué significa eso? Básicamente
 * dice, pásame un R pero este, debe extender JpaRepository <T, ID>
